...
public class BoardController {
	...
	public ModelAndView delete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		@RequestMapping(value = "/board/complain", method = RequestMethod.GET)
		public ModelAndView complain(HttpServletRequest req, HttpServletResponse resp)
			...
			return new ModelAndView("redirect:/board/article?page=" + page + "&size=" + size + "&num=" + num);

		}
		
		@RequestMapping(value = "/board/ban", method = RequestMethod.GET)
