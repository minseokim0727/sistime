						...
						<tr>
							...
							<td class="text-end">
								<button type="button" class="btn btn-light"
									...
									<form action ="${pageContext.request.contextPath}/event/complain">
								...
								<button type="submit" class="btn btn-light"
									onclick="">신고</button>
								<input type="hidden" name="board_name" value="event"> 
								...
								<form action ="${pageContext.request.contextPath}/event/ban">
